---
title: "Clustering through epigraph and hypograph indices"
...
In this subsection, we are going to display how to validate the results of the
`EHyClus` function. First, we are going to generate multidimensional data
using `sim_model_ex2`:
